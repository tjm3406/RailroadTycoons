...
/**
 * {@linkplain Card Cards} in a {@linkplain RailroadBarons Railroad Barons} game are dealt to each
 * {@linkplain Player} in pairs. This class is used to hold one such pair of {@linkplain Card
 * cards}. Note that, if the deck is empty, one or both cards may have a value of "{@link Card#NONE
 * none}."
 */
