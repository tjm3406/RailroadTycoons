...
public interface Space {
  ...
  /**
   * Returns true if the other space is occupying the same physical location in the map as this
   * space.
   *
   * @param other The other space to which this space is being compared for collocation.
   * @return True if the two spaces are in the same physical location (row and column) in the map;
   * false otherwise.
   */
