...
/**
 * Interface for a class that should be notified whenever the state of a {@linkplain RailroadBarons
 * Railroad Barons game} changes.
 */
public interface RailroadBaronsObserver {
  ...
  /**
   * Called when the {@linkplain RailroadBarons Railroad Barons game} is over.
   *
