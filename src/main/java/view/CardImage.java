...
/**
 * An enum used to determine which image to use when displaying {@linkplain Card cards} in the
 * Railroad Barons UI. Associates a specific image with each type of card.
 */
public enum CardImage {
  ...
  /**
   * A {@linkplain Map map} of {@linkplain Card cards} to {@linkplain CardImage card images} used
   * for easy lookup.
   */
  ...
  /**
   * The {@link Image} that should be used to display a card of the specified type.
   */
  private final Image image;

  /**
   * Creates a new {@linkplain CardImage} with the specified {@linkplain Card card} and image name.
   *
   * @param card The type of card that needs to be displayed {@link Card}.
   * @param imageName The name of the image to use when displaying cards of this type.
   */
  ...
  /**
   * Returns the {@link Image} used to display the {@link Card} associated with this card image.
   *
