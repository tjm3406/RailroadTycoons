...
public interface RailroadBaronsView {
  ...
  /**
   * The CSS used to style the font so that it is centered and has a 1px black stroke.
   */
  String FONT_CSS =
      "-fx-font-weight: bold;" +
          "-fx-stroke: black;" +
  ...
  /**
   * Helper method that returns a valid CSS color constant for a given {@linkplain Baron}.
   *
   * @param baron The {@link Baron} for whom to fetch the appropriate color constant.
  ...
  /**
   * Returns the CSS to style a font that uses the {@link #DEFAULT_FONT_SIZE default size} and
   * specified color.
   *
   * @param color The color for the font style.
   * @return The CSS for a font that uses the default size and specified color.
   */
