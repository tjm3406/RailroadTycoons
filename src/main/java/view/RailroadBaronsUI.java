...
public class RailroadBaronsUI extends Application
  ...
  /**
   * The usage error message if the game is executed with the wrong number of arguments.
   */
  ...
  /**
   * The {@link RailroadBaronsController} used to facilitate communication to and from the model.
   */
  ...
  /**
   * The primary {@link Stage} in which the Railroad Barons used interface is updated.
   */
  ...
  /**
   * Builds the {@linkplain MenuBar menu bar} used by the Railroad Barons users to load and save
   * maps.
   *
  ...
  /**
   * Starts a new game by first prompting the user to open a map file using the {@linkplain
   * FileChooser file chooser}, loads the map into the UI using the {@linkplain
   * RailroadBaronsController controller}, and sizes the stage to fit the new map.
   */
