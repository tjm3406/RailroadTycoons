...
/**
 * The deck pane displays all of the information that a {@linkplain Player player} needs to know
 * about number of {@linkplain Card cards} remaining in the {@linkplain Deck deck} any cards dealt
 * at the start of the player's turn.
 */
public class DeckPane extends BorderPane implements RailroadBaronsView {

  /**
   * Initial string of text displayed in lieu of {@link Player} information before the start of a
   * game.
   */
  private static final String GAME_NOT_STARTED = "Game Not Started";

  /**
   * A {@link Text} that is used to display the {@link Player Player's} name and color.
   */
  private final Text playerInfo;

  /**
   * The {@link CardView} used to display the number of cards remaining in the game {@link Deck}.
   */
  private final CardView deck;

  /**
   * The {@link CardView} used to display the first card in the {@link Pair} that was dealt to the
   * {@link Player} at the start of their turn.
   */
  private final CardView cardOne;

  /**
   * The {@link CardView} used to display the second card in the {@link Pair} that was dealt to the
   * {@link Player} at the start of their turn.
   */
  ...
  /**
   * Helper method that makes a new {@linkplain CardView card view} with default settings for the
   * deck pane including: <ul> <li>Uses the {@linkplain CardImage#BACK card back} image.</li>
   * <li>Displays no card number.</li> <li>Is invisible.</li> </ul>
   *
   * @return A new {@link CardView} with the default settings for a deck pane.
   */
  ...
  /**
   * Updates the number of {@linkplain Card cards} remaining in the game {@linkplain Deck deck}.
   * This number is displayed to all {@linkplain Player players}.
   *
   * @param numberOfCardsRemaining The number of cards remaining in the current game.
   */
  ...
  /**
   * Called whenver the information displayed should be changed to match the specified {@linkplain
   * Player player}, e.g. at the start of the player's turn (to show the {@linkplain Pair pair} of
   * cards dealt to the player.
   *
   * @param player The {@link Player} that should be used to update the display.
   */
  ...
  /**
   * Places the {@linkplain CardView card views} used to display the {@linkplain Pair pair} of
   * {@linkplain Card cards} dealt to the {@linkplain Player player} at the start of their turn
   * {@linkplain CardView#placeFaceDown() face down}, hiding them from other players that are
   ...
   * Places the {@linkplain CardView card views} used to display the {@linkplain Pair pair} of
   * {@linkplain Card cards} dealt to the {@linkplain Player player} at the start of their turn
   * {@linkplain CardView#placeFaceUp() face up} revealing them to the player that is currently
   * playing once no other players are looking at the screen.
   */
  void placeFaceUp() {
    cardOne.placeFaceUp();
    cardTwo.placeFaceUp();
