...
/**
 * An implementation of the {@linkplain Console} that writes all output to a {@linkplain TextArea
 * text area}.
 */
public class TextAreaConsole extends TextArea implements Console {
  ...
  /**
   * Creates a new {@linkplain Console console} that appends lines of text to a scrolling
