...
public class ComputerPlayerTest {
  ...
  private RailroadBaronsLonely railRoadBarons;

  @Before
  public void setUp() throws Exception {
    RailroadBaronsLonely railRoadBarons = new RailroadBaronsLonely();
    this.railRoadBarons = railRoadBarons;
    player1 = new student.ComputerPlayer(Baron.RED, railRoadBarons);
    player2 = new student.ComputerPlayer(Baron.BLUE, railRoadBarons);
  ...
  public void canClaimRoute() {
    ...
    model.Route route1 = dummyRailroadMap.getRoute(2, 5);
    model.Route route2 = dummyRailroadMap.getRoute(5, 2);
  ...
  public void play() throws RailroadBaronsException {
    System.out.println("Running play() test");

    railRoadBarons.startAGameWith(dummyRailroadMap);
    railRoadBarons.setCurrentPlayer(1);
    player1 = (ComputerPlayer) railRoadBarons.getCurrentPlayer();
